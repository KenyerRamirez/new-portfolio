...
export function ExperienceSection() {
  const experiences = [
    ...
    },
    {
      ...
      technologies: ["React", "Python", "PostgreSQL", "MySQL", "React Native", "Node.js", "AWS", "Azure", "Strapi"],
      achievements: [
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <div key={index} className="bg-card border border-border rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <h5 className="font-medium text-foreground mb-2">Main Achievements:</h5>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.technologies.map((tech, i) => (
                      <span key={i} className="inline-flex items-center rounded-md border border-border bg-background px-2.5 py-0.5 text-xs font-medium text-foreground">
                        {tech}
                      </span>
                    ))}
                  </div>
